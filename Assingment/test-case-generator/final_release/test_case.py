#  ------------------------------------------------- ###
#  ------------------------------------------------- ###
#  ### Developed by SUNIL SHARMA (aka sunbyte16). ###
#                github.com/sunbyte16               ###
...
class Case:
    ...
    def home(self):
        ...
        self.copyright_label = Button(gui, text='© sunbyte16', fg='white', width=7, height=1, bd=3, command=lambda:
                                webbrowser.open_new_tab("https://github.com/sunbyte16"), font=('calibre', 6, 'normal'))
        self.copyright_label.configure(bg=mycolor)
        self.retrieve_home(self)

    def newformat(self):
        url = "https://github.com/sunbyte16/test-case-generator/issues/new?assignees=&labels=&" \
              "template=suggest-test-case.md&title=Suggest+Test+Case"
        webbrowser.open_new_tab(url)

    def feedback(self):
        url = "https://github.com/sunbyte16/test-case-generator/issues/new/choose"
        webbrowser.open_new_tab(url)
